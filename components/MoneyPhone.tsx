  ...
  return (
    <section className="relative w-full py-24 px-6 overflow-hidden flex flex-col items-center">
      ...
      <div className="flex flex-col md:flex-row items-center justify-center gap-12 md:gap-24 max-w-6xl mx-auto w-full">
        ...
        <div className="relative w-[300px] h-[600px] md:w-[350px] md:h-[700px] order-1 md:order-2 perspective-1000 group">
          
          {/* Unified Rotation Wrapper - Handles both Hand and Phone */}
          <div className="w-full h-full relative transition-transform duration-700 ease-[cubic-bezier(0.25,0.1,0.25,1)] transform rotate-0 group-hover:-rotate-12 origin-bottom-right">
            ...
            {/* Phone Container */}
            <div className="absolute inset-0 bg-[#1A2A3A] rounded-[3rem] border-[8px] border-[#1A2A3A] shadow-2xl z-10 overflow-hidden ring-1 ring-white/20">
              
              {/* Casing Highlights (Metallic Rim) */}
              <div className="absolute inset-0 rounded-[2.5rem] shadow-[inset_0_0_15px_rgba(255,255,255,0.1)] pointer-events-none z-50"></div>
              
              {/* Screen Glass Reflection (Diagonal Gloss) */}
              <div className="absolute -inset-[100%] bg-gradient-to-br from-white/10 via-transparent to-transparent opacity-40 z-40 pointer-events-none rotate-45 transform translate-y-20"></div>

              {/* Notch */}
              <div className="absolute top-0 left-1/2 -translate-x-1/2 w-32 h-7 bg-[#1A2A3A] rounded-b-2xl z-30 shadow-sm border-b border-white/5"></div>
              
              {/* Screen Content */}
              <div className="w-full h-full bg-[#FDFBF7] flex flex-col pt-12 relative">
                
                {/* Screen Depth Shadow */}
                <div className="absolute inset-0 shadow-[inset_0_4px_12px_rgba(0,0,0,0.05)] pointer-events-none z-20"></div>

                {/* Status Bar */}
                <div className="flex justify-between px-6 mb-4 text-[#1A2A3A]/40 text-xs font-bold relative z-10">
                   <span>9:41</span>
                ...
                {/* Feed Area */}
                <div className="flex-1 bg-white rounded-t-[2rem] shadow-[0_-10px_40px_rgba(0,0,0,0.05)] p-6 overflow-hidden flex flex-col gap-4 relative z-10">
                   <div className="text-xs font-bold uppercase text-[#2D9C8E] mb-2 animate-pulse tracking-widest flex items-center gap-2">
                     <span className="w-1.5 h-1.5 rounded-full bg-[#2D9C8E]"></span>
                     Incoming Tributes
                   </div>
                ...
                {/* Bottom Nav Mock */}
                <div className="h-16 bg-white border-t border-gray-100 flex justify-around items-center px-6 relative z-10">
