...
export const OriginStory: React.FC = () => {
  return (
    <section id="origin" className="min-h-[100dvh] flex flex-col justify-center py-12 md:py-16 bg-[#FDFBF7] relative overflow-hidden border-b border-[#1A2A3A]/5">
      ...
      <div className="max-w-7xl mx-auto w-full">
        ...
        <div className="mb-12 md:mb-16 text-center max-w-4xl mx-auto">
          ...
          <h2 className="text-4xl md:text-7xl font-bold text-[#1A2A3A] tracking-tighter mb-8 leading-[0.9] uppercase">
            I'M F*CKING ORANOLIO. <br/>
          ...
          <p className="text-xl text-[#1A2A3A]/60 max-w-2xl mx-auto">
            I don't follow rules. I make them. I don't ask for money. I take it. <br/>
            You are reading this because you want to be me. But you can't be me. <br/>
            <span className="text-[#1A2A3A] font-bold">I am the glitch in the simulation.</span>
          </p>
        </div>
            ...
            <div className="bg-[#1A2A3A]/5 p-6 md:p-12 rounded-3xl relative overflow-hidden border border-[#1A2A3A]/10 group hover:bg-[#1A2A3A]/10 transition-colors flex flex-col justify-center">
                ...
                <ul className="space-y-4 md:space-y-6 text-[#1A2A3A]/70 font-medium text-sm md:text-base">
                    <li className="flex gap-4">
                        ...
                        <div>
                            <strong className="block text-[#1A2A3A]">The Origin</strong>
                            My mom wouldn't buy me pizza. So I pretended to be a girl on a forum. 40 minutes later, 8 pizzas arrived at my door. I realized I was a god.
                        </div>
                    </li>
                    <li className="flex gap-4">
                        <span className="text-xl">📦</span>
                        <div>
                            ...
                            It was literally free money. I'd sell a folder of pics for $20 to 50 guys a day. $1,000 daily for copying and pasting a link.
                        </div>
                    </li>
                    <li className="flex gap-4">
                        ...
                        <div>
                            ...
                            "Oops, the link didn't work? Send another $20." They fell for it every time.
                        </div>
                    </li>
                </ul>
            </div>
